...
const FISH = [
  ...
  { id: "bigmouth-shiner", commonName: "Bigmouth Shiner", sciName: "Ericymba dorsalis", group: "Carps & Minnows", note: "Most texts say Notropis dorsalis; iNaturalist files this under Ericymba dorsalis. Verify it's the same fish." },
  ...
  { id: "blacknose-dace", commonName: "Blacknose Dace", sciName: "Rhinichthys obtusus", group: "Carps & Minnows", note: "Split taxon: R. atratulus is Eastern Blacknose Dace (0 records in our 5 states); R. obtusus is Western Blacknose Dace (39). Using the western one — confirm that's what your students see." },

  { id: "bowfin", commonName: "Bowfin", sciName: "Amia ocellicauda", group: "Primitive Fishes", note: "Bowfin was split in 2022: A. calva is the eastern form (0 records in our 5 states); A. ocellicauda 'Eyetail Bowfin' is the Great Lakes/Mississippi form (21). Using ocellicauda — confirm." },
  { id: "paddlefish", commonName: "Paddlefish", sciName: "Polyodon spathula", group: "Primitive Fishes" },
  { id: "lake-sturgeon", commonName: "Lake Sturgeon", sciName: "Huso fulvescens", group: "Primitive Fishes", note: "Most texts say Acipenser fulvescens; iNaturalist has moved it to Huso fulvescens. Verify it's the same fish." },
...
const HERPS = [
  ...
  { id: "eastern-gray-tree-frog", commonName: "Eastern Gray Tree Frog", sciName: "Dryophytes versicolor", group: "Frogs & Toads", hasCall: true, note: "Most texts say Hyla versicolor; iNaturalist uses Dryophytes versicolor. ALSO visually identical to Cope's Gray Treefrog (D. chrysoscelis) — call is the reliable separator, so watch for misidentified photos. Note iNat also has a 'complex' rank taxon of the same name — pick the species-rank one." },
